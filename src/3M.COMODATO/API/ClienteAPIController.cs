    ...
    public class ClienteAPIController : BaseAPIController
    {
        ...
        public IHttpActionResult ObterListaClienteSinc(Int64 idUsuario)
        {
            ...
            try
            {
                ...
                //JO.Add("CLIENTE", JsonConvert.SerializeObject(listaCliente, Formatting.None));
        ...
        public IHttpActionResult AlterarEnvioPesquisa(string fl_pesq_satisf, long nidUsuario)
        {
            try
            {
                ...
                return Ok(_3M.Comodato.Utility.ControlesUtility.Constantes.MensagemGravacaoSucesso);
            }
            catch (Exception ex)
            {
                LogUtility.LogarErro(ex);
        ...
        public IHttpActionResult CalcularKAT(int CD_CLIENTE)
        {
            ...
            jObject.Add("retorno", JsonConvert.SerializeObject(retorno, Formatting.None));
        ...
        public IHttpActionResult GerarRelatorioKAT()
        {
            ...
            JObject jObject = new JObject();
            jObject.Add("retorno", JsonConvert.SerializeObject("Sincronização efetuada com sucesso!", Formatting.None));
