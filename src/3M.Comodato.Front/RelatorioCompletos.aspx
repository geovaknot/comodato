<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioCompletos.aspx.cs" Inherits="_3M.Comodato.Front.RelatorioCompletos" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlMensagem" runat="server" Visible="false">
            <hgroup>
                ...
                <h3>Relatório - Análise de Vendas - Detalhado</h3>
