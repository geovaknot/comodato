...
$('#usuario_nidUsuario').change(function () {
    OcultarCampo($('#validaUSERS'));
});

$("#wfGrupo_ID_GRUPOWF").change(function () {
    OcultarCampo($('#validaGROUP'));
...
$('#btnAdicionar').click(function () {
    ...
    var CD_USUARIO = $('#usuario_nidUsuario').val()
    var CD_GROUP = $("#wfGrupo_ID_GRUPOWF").val()
    ...
    if (CD_USUARIO == "") {
        ExibirCampo($('#validaUSERS'));
        return;
    } else if (CD_GROUP == "") {
        ExibirCampo($('#validaGROUP'));
        return;
    }
