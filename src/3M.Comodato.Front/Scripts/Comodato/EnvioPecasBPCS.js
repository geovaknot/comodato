...
function carregarGridMVC() {
    ...
    var URL = URLObterListaSolicitacaoBPCS + "?CD_CLIENTE=" + CD_CLIENTE + "&CD_TECNICO=" + CD_TECNICO + "&CD_PEDIDO=" + CD_PEDIDO + "&ID_STATUS_PEDIDO=" + ID_STATUS_PEDIDO + "&ID_STATUS_PEDIDO_RECEBIDO_PENDENCIA=" + ID_STATUS_PEDIDO_RECEBIDO_PENDENCIA + "&DT_CRIACAO_INICIO=" + DT_CRIACAO_INICIO + "&DT_CRIACAO_FIM=" + DT_CRIACAO_FIM;
