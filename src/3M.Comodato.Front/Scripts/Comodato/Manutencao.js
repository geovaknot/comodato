...
$('#btnImprimir').click(function () {
    ...
    var codigoGrupo = '';
    if (null != $("#ddlGrupo").val() && $("#ddlGrupo").val() != '')
    ...
    if (null != $("#ddlEquipamento").val() && $("#ddlEquipamento").val() != '')
        codigoEquipamento = $("#ddlEquipamento").val();

    var codigoVisita = '';
    if (null != $("#ddlVisita").val() && $("#ddlVisita").val() != '')
        codigoVisita = $("#ddlVisita").val();

    var codigoOS = '';
    if (null != $("#ddlOS").val() && $("#ddlOS").val() != '')
        codigoOS = $("#ddlOS").val();
    ...
    if (periodoValido) {
        ...
        var parametros = DT_INICIAL + "|" + DT_FINAL + '|' +
            codigoGrupo + "|" + codigoCliente + "|" +
            codigoTecnico + "|" + codigoEquipamento + "|" +
            codigoVisita + "|" + codigoOS + "|" + ModeloRelatorio;
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.idKey != null && res.idKey != '') {
                    window.open(URLSite + '/RelatorioManutencao.aspx?idKey=' + res.idKey, '_blank');
                }
            },
            error: function (res) {
                $("#loader").css("display", "none");
