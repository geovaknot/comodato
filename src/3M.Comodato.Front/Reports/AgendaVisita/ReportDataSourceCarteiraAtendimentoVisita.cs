...
{
    public class ReportDataSourceCarteiraAtendimentoVisita : List<AgendaAtendimentoVisita>
    {
    }
    public class AgendaAtendimentoVisita
    {
        ...
        public string DS_MOTIVO_VISITA { get; set; }
        public string DS_STATUS_VISITA { get; set; }
        public string NM_NOTA_PESQ { get; set; }
