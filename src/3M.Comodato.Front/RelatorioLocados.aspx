<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioLocados.aspx.cs" Inherits="_3M.Comodato.Front.RelatorioLocados" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlMensagem" runat="server" Visible="false">
            <hgroup>
                ...
                <h3>Relatório - Equipamentos Locados</h3>
