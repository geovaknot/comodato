<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioResumos.aspx.cs" Inherits="_3M.Comodato.Front.RelatorioResumos" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlMensagem" runat="server" Visible="false">
            <hgroup>
                ...
                <h3>Relatório - Análise de Vendas - Resumo</h3>
