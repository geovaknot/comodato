...
namespace _3M.Comodato.Data
{
    public class PlanoZeroData
    {
        ...
        public void CancelarPedidosPZ(int id)
        {
            ...
            query += $" UPDATE tb_pedido_peca SET st_status_item = '4' FROM tb_pedido_peca A JOIN tb_pedido B ON A.id_pedido = B.id_pedido WHERE b.idcontroleplanozero = {id} and b.id_status_pedido = 2";
