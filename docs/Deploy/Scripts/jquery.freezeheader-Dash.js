...
(function ($) {
    var TABLE_ID = 0;
    $.fn.freezeHeaderDash = function (params) {

        var copiedHeader = false;

        function freezeHeaderDash(elem) {
            ...
            if (elem.length > 0 && elem[0].tagName.toLowerCase() == "table") {
                ...
                obj.scroller.on('scroll', function () {
                    ...
                    if (obj.header.offset() != null) {
                        if (limiteAlcancadoDash(obj, params)) {
                            elem.trigger("freeze:on");
                            if (!copiedHeader) {
                                cloneHeaderRowDash(obj);
                                copiedHeader = true;
                            }
                        }
                        else {
        ...
        function limiteAlcancadoDash(obj, params) {
        ...
        function cloneHeaderRowDash(obj) {
            obj.container.html('');
            obj.container.val('');
            ...
            if (params && params.height !== undefined) {
                ...
                else
                {
                    ...
                    // Adicionado WABR
                    obj.container.css("top", "0px");
                    obj.container.addClass("mx-0 my-0 px-0 py-0");
                }
