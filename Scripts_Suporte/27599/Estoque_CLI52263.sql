...
delete from tbEstoqueMovi where ID_ESTOQUE = 676
delete from tbEstoque where ID_ESTOQUE = 676

declare @idestoqueatual numeric(6) = 682,
		@idestoqueantigo numeric(6) = 672
