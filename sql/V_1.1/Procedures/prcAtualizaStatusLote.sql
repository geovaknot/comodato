GO
/****** Object:  StoredProcedure [dbo].[prcAtualizaStatusLote]    Script Date: 08/03/2022 08:48:05 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	DECLARE @cdsErrorMessage	NVARCHAR(4000),
			...
			@STATUS_ITEM_APROVADO TINYINT = 3
				...
				BEGIN
					UPDATE TB_PEDIDO_PECA 
					   SET ST_STATUS_ITEM = CASE 
												...
												WHEN (QTD_APROVADA > 0 AND QTD_RECEBIDA is null and QTD_ULTIMO_RECEBIMENTO is null) THEN @STATUS_ITEM_APROVADO
												WHEN (QTD_APROVADA > 0 AND QTD_RECEBIDA = 0 and QTD_ULTIMO_RECEBIMENTO = 0) THEN @STATUS_ITEM_APROVADO
												WHEN (QTD_APROVADA > 0 AND QTD_RECEBIDA is null and QTD_ULTIMO_RECEBIMENTO = 0) THEN @STATUS_ITEM_APROVADO
												WHEN (QTD_APROVADA > 0 AND QTD_RECEBIDA = 0 and QTD_ULTIMO_RECEBIMENTO is null) THEN @STATUS_ITEM_APROVADO
											 END
					 WHERE ID_PEDIDO = @p_ID_PEDIDO
